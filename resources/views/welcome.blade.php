    ...
    <div id="backgroundCarousel" class="carousel slide" data-bs-ride="carousel" data-bs-interval="3000">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="d-block w-100" src="{{ asset('assets/img1.jpeg') }}" alt="image 1" style="height: 100vh; object-fit: cover; opacity: 0.6;">
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" src="{{ asset('assets/img2.jpeg') }}" alt="image 2" style="height: 100vh; object-fit: cover; opacity: 0.6;">
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" src="{{ asset('assets/img3.jpeg') }}" alt="image 3" style="height: 100vh; object-fit: cover; opacity: 0.6;">
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" src="{{ asset('assets/img4.jpeg') }}" alt="image 3" style="height: 100vh; object-fit: cover; opacity: 0.6;">
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" src="{{ asset('assets/img5.jpeg') }}" alt="image 3" style="height: 100vh; object-fit: cover; opacity: 0.6;">
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" src="{{ asset('assets/img6.jpeg') }}" alt="image 3" style="height: 100vh; object-fit: cover; opacity: 0.6;">
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" src="{{ asset('assets/img7.jpeg') }}" alt="image 3" style="height: 100vh; object-fit: cover; opacity: 0.6;">
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" src="{{ asset('assets/img8.jpeg') }}" alt="image 3" style="height: 100vh; object-fit: cover; opacity: 0.6;">
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" src="{{ asset('assets/img9.jpeg') }}" alt="image 3" style="height: 100vh; object-fit: cover; opacity: 0.6;">
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" src="{{ asset('assets/img10.jpeg') }}" alt="image 3" style="height: 100vh; object-fit: cover; opacity: 0.6;">
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" src="{{ asset('assets/img11.jpeg') }}" alt="image 3" style="height: 100vh; object-fit: cover; opacity: 0.6;">
            </div>
                ...
                <div class="col-md-6 col-lg-4 mb-5">
                    <div class="card candidate-card shadow-lg border-0">
                        ...
                        <div class="card-body text-center">
                            ...
                            @auth
                            <button class="btn btn-primary btn-voter shadow-sm" data-id="{{ $candidat->id }}"  data-poste-id="{{ $poste->id }}">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content shadow text-center">
            ...
            <div class="modal-body">
                <img src="{{ asset('assets/erreur.png') }}" alt="Erreur" class="img-fluid mb-3 rounded-circle shadow" style="max-width: 120px;">
                <p class="fs-5">Vous avez déjà voté pour ce poste. <strong style="font-weight: bold"></strong></p>
                <img src="{{ asset('assets/emoji.jpg') }}" alt="emoji" class="img-fluid mb-3 rounded-circle shadow" style="max-width: 120px;">
...
<div class="modal fade" id="successVoteModal" tabindex="-1" aria-labelledby="successVoteModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content shadow text-center">
            ...
            <div class="modal-body">
                <img src="{{ asset('assets/felicitation.jpg') }}" alt="Félicitations" class="img-fluid mb-3 rounded-circle shadow" style="max-width: 120px;">
                <p class="fs-5">Félicitations, <span style="color: #0056b3"> </span>  <strong id="voterName"></strong> !</p>
